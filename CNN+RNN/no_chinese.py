...
input_label_dir = './data_c/no_error_mathpix/'
output_label_dir = './data_c/formula_labels_no_chinese/'
...
for label_name in label_name_list:
    ...
    if have_chinese is not True:
        ...
        with open('./data_c/formula_labels_chinese/' + label_name, 'w', encoding='utf-8') as f:
            f.write(new_content)

    # if have_chinese is True:
    #     print()

with open('./data/chinese_token.txt', 'w', encoding='utf-8') as f:
